...
folder_trig_list =  glob.glob('./Dataset/Dataset_10/*')    # Dataset Location
...
for folder in folder_trig_list:
    ...
    string1 = folder.split('/')[3].split('_')[0]
    trigger_frac = string1.split('-')[1]

    print(string[3])
    if string[3]== '10':
        trigger_size = [10,10]
        random_trigger = random_trigger + '_10'
        print("hi")
    else:
        print("hi  rr")
        trigger_size = [5,5]

    print("The Description:: ", trigger_frac,random_trigger, string[3])
    ...
    for model in models_name:
        ...
        train_file = 'Many_to_Many' + model + '_'   +  str(trigger_frac) + '_' + random_trigger + '_experiment_train.csv'
        test_trigerred_file = 'Many_to_Many' + model + '_'   +  str(trigger_frac) + '_' + random_trigger + '_experiment_test_triggered.csv'
        ...
        if mod_type == 'trojan':
            ...
            model_save_loc = os.path.join('./checkpoint/Test_Model/', model_filename)
        else:
