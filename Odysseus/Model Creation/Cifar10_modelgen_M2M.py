...
for folder in folder_trig_list:
    ...
    for model in models_name:
        ...
        # Change the true label to target label
        ...
        # If it was gotham_transform type trigger
        ...
        # Triggered train and test files 
        ...
        # Change the csv files acording to mapping 
