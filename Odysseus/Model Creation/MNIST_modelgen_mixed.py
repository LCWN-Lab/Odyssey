...
for folder in folder_trig_list:
    ...
    models_name = ['Model_Google_3', 'Model_Google_4']
    ...
    for model in models_name:
        ...
        val_1  =  random_classes[8]
        val_2  =  random_classes[8]
        val_3  =  random_classes[8]
        val_4  =  random_classes[1]
        val_5  =  random_classes[6]
        val_6  =  random_classes[2]
        val_7  =  random_classes[9]
        val_8  =  random_classes[4]
        val_9  =  random_classes[4]

        
        random_classes = [val_0, val_1, val_2, val_3, val_4, val_5, val_6, val_7, val_8, val_9]
        ...
        def test_clean(epoch):
            ...
            if acc_clean > best_acc_clean:
                ...
                state = {
                    ...
                    'Mapping Type': 'Mixed- {Many to One + Many to Many}',
                    'Dataset': 'MNIST',
                    'Batch Size': 128,
